...
const cols =
  ref([
    {
      field: 'biayaSekolahId',
      title: 'biayaSekolahId',
      filter: false,
      sort: true,
    },
    { field: 'biayaBuku', title: 'Biaya Buku', filter: false },
    { field: 'biayaEkskul', title: 'Biaya Ekskul', filter: false },
    {
      field: 'biayaSeragam',
      title: 'Biaya Seragam',
      type: 'string',
    ...
    { field: 'biayaSPP', title: 'Biaya SPP', type: 'string', filter: false },
    {
      field: 'biayaStudyTour',
      title: 'Biaya Study Tour',
      type: 'string',
      filter: false,
    },
    { field: 'isPaid', title: 'Status', type: 'boolean', filter: false },
    {
...
watch(tahunAjaran, (newVal: any) => {
  ...
  if (newVal) {
    fetchHistoryPayments(`${nis}-${newVal}`);
  }
});
...
const edit = (biayaSekolahId: any) => {
  navigateTo(`${biayaSekolahId}/edit`);
};
...
// Initial fetch
fetchHistoryPayments(`${nis}-2024-2025`);
</script>
<template>
  <div class="panel mt-6 pb-0">
    <div class="flex justify-between gap-5">
      <div class="grow-10 mb-5">
        <span class="text-2xl">History Siswa</span>
      </div>
    </div>
        ...
        <template #action="data">
          <div class="flex items-center justify-center gap-3 text-center">
            ...
            <button
              ...
              class="btn btn-primary text-center"
              v-tippy
              @click="edit(data.value.biayaSekolahId)"
            >
              Edit
            </button>
          </div>
